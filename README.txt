...
- <h1> to <h6>: Headings to organize page structure.
- <nav>: Grouped navigation links.
- <ul>/<ol>: Unordered and ordered lists used for skills and education.
- <img>: Image of the project with alt text for easy accessibility.
- <table>: Displayed projects in tabular form.
...
Favicon:
A .ico file is linked in each page using the <link rel="icon"> tag.

Built by Saksham with pure HTML5. No CSS yet — that's for the next lesson :)
